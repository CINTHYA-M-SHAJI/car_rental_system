...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand"> <span>USER NAME: <input type="name" readonly value="<?php echo $_SESSION['name'];?>"></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item"><a href="profile.php" class="nav-link">Profile</a></li>
	          <li class="nav-item"><a href="view_booking.php" class="nav-link">Booking</a></li>
    ...
    <div class="hero-wrap ftco-degree-bg" style="background-image: url('images/car.webp');" data-stellar-background-ratio="0.5">
    			...
    			<div class="col-md-12	featured-top">
    				<div class="row no-gutters">
	  					<div class="col-md-4 d-flex align-items-center">
	  						...
	  						<form action="view_car.php" method="POST" class="request-form ftco-animate bg-primary" id="booking">
		          		<h2>Make your trip</h2>
			    				<div class="form-group">
			    					<label for="" class="label">Pick-up date</label>
									
									<input type="date" class="form-control" id="f_date"  select name="f_date"  required >
			    					<!-- <input type="text" class="form-control" id="book_pick_date" placeholder="Date"> -->
			    				</div>
			    				<div class="form-group">
			    					<label for="" class="label">Drop-off date</label>
									<input type="date" class="form-control" id="t_date"  select name="f_date"  required >
                                    <!-- <input type="date" class="form-control"  id="t_date" select name="t_date" data-date="" data-date-format="DD MMMM YYYY" value="dd-mm-yyyy" required> -->
