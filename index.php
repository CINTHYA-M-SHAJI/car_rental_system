    ...
    $('#t_date').attr('min', minDate);
    		...
    		<div class="row no-gutters">
    			<div class="col-md-12	featured-top">
                    ...
                    <input type="date" class="form-control" data-date=""  id="f_date"  select name="f_date" data-date-format="DD MMMM YYYY" value="dd-mm-yyyy" required>
			    					<!-- <input type="text" class="form-control" id="book_pick_date" placeholder="Date"> -->
			    				</div>
			    				<div class="form-group">
			    					<label for="" class="label">Drop-off date</label>
                    <input type="date" class="form-control" data-date=""  id="t_date"  select name="t_date" data-date-format="DD MMMM YYYY" value="dd-mm-yyyy" required>
                ...
                <div class="car-wrap rounded ftco-animate">
                      <div class="img rounded d-flex align-items-end">
                        ...
                        <div class="text">
						   ...
						   <p class="cat"> <?php echo $row['model'];?><span></span></p>
